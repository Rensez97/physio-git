...
def get_website(name,place):
    ...
    # print(search_str)
    # user_agent = googlesearch.user_agents.get_useragent()
...
def connect_drive():
    ...
    SERVICE_ACCOUNT_FILE = "C:/Users/rense/Documents/Werk/Physio/testuser-key.json"
    PARENT_FOLDER_ID = "1_xPWq2NwdQxIOhS5vFP8e2XK5t791sE9"
    ...
    id = items[1]['id']
    print(id)
    request_file = drive_service.files().get_media(fileId=id)
    file = io.BytesIO()
    ...
    # Create a pandas DataFrame directly from the binary data
...
def main():
    ...
    # get_website("Klinik Hirslanden","Zürich")
    ...
    # with open("latest_results 15012024.pkl", "rb") as f:
    ...
    # df_latest_results.sort_values(by=["Stellenangebot online per", "Arbeitgeber"], inplace=True, ascending=[False,True])

    # df_only_databank = df_full_databank[df_full_databank["Aktiv"] == ""]
    # df_only_databank.sort_values(by=["Archivierungsdatum", "Arbeitgeber"], inplace=True, ascending=[False,True])
